...
pub struct Conjunction2Int
{
  conjunction: Vec<Box<Subsumption<VStore>>>,
}

impl Conjunction2Int {
  pub fn new() -> Conjunction2Int {
    Conjunction2Int {
      conjunction: vec!(),
    }
  }
...
impl Debug for Conjunction2Int
{
...
impl<Store> Subsumption<Store> for Conjunction2Int
{
